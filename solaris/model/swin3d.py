...
from solaris.model.film import AdaptiveLayerNorm
from solaris.model.fourier import lead_time_expansion
from solaris.model.lora import LoRAMode, LoRARollout
from solaris.model.util import init_weights, maybe_adjust_windows
    ...
    def __init__(
        ...
        Args:
            ...
            scale_bias (float, optional): Scale bias for
                :class:`solaris.model.film.AdaptiveLayerNorm`. Defaults to `0`.
            lora_steps (int, optional): Maximum number of LoRA roll-out steps. Defaults to `40`.
            lora_mode (str, optional): Mode. `"single"` uses the same LoRA for all roll-out steps,
                and `"all"` uses a different LoRA for every roll-out step. Defaults to `"single"`.
...
class BasicLayer3D(nn.Module):
    ...
    def __init__(
        ...
        Args:
            ...
            scale_bias (float, optional): Scale bias for
                :class:`solaris.model.film.AdaptiveLayerNorm`. Default: 0
            lora_steps (int, optional): Maximum number of LoRA roll-out steps. Defaults to `40`.
            lora_mode (str, optional): Mode. `"single"` uses the same LoRA for all roll-out steps,
                and `"all"` uses a different LoRA for every roll-out step. Defaults to `"single"`.
            use_lora (bool): Enable LoRA. By default, LoRA is disabled.
