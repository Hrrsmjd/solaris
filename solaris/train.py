...
import time
import datetime
from solaris.load_data import CustomDataset_downstream,CustomDataset_pretrain
...
def main():
    ...
    train_dataset = CustomDataset_pretrain(root_dir=args.data_path, data_set="train")
    val_dataset = CustomDataset_pretrain(root_dir=args.data_path, data_set="val")
